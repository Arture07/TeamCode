...
import com.crewcode.sessionservice.dto.UpdateFileRequest;
import com.crewcode.sessionservice.model.CodingSession;
import com.crewcode.sessionservice.service.SessionService;
...
public class SessionController {
    ...
    private final com.crewcode.sessionservice.util.JwtTokenHelper jwtTokenHelper;

    public SessionController(SessionService sessionService, com.crewcode.sessionservice.util.JwtTokenHelper jwtTokenHelper) {
    ...
    public ResponseEntity<?> claimSession(
        ...
        com.crewcode.sessionservice.util.JwtTokenHelper.UserTokenInfo userInfo = jwtTokenHelper.parseToken(authHeader);
